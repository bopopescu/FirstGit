...
<body class="{% if request.COOKIES.sidebar_pinned != 'false' %}menu-pinned {% endif %}{% if is_popup %}popup {% endif %}{% block bodyclass %}{% endblock %}"
  data-admin-utc-offset="{% now "Z" %} slider-cover"/>
        ...
        <div class="sidebar sidebar-dependent">
            <div class="sidebar-wrapper scrollable">
                <div class="sidebar-section">
                    {% if user.is_active and user.is_staff %}
                        <a href="http://www.fleeca.in/" class="sidebar-link icon" target="_blank">
                    ...
                    {% endif %}
                    {% if site_url %}
                        <a href="http://www.fleeca.in/contact.php" class="sidebar-link icon" target="_blank">
                            <span class="sidebar-link-label">
